...
npm run dev
```
## 3. Mandatory API Routes & Frontend Communication:
...
## 6. Database Creation & Initialization:
...
## 7.  two cURL commands and the results
...
{"error":"Invalid token."}
```
## 8.  Limitation of the submitted application.
